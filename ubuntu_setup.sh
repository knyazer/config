...
# vim - console editor
# gh - github cli
apt_install htop neofetch docker clang lldb lld curl aptitude terminator base-devel cmake node python3.10 flatpak gnome-tweak-tool zsh git vim node wget gpg gh || true
