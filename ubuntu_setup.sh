...
apt_install htop neofetch docker docker.io clang lldb lld curl aptitude terminator base-devel cmake node python3.10 python3-pip \
        ...
        wireguard xclip openjdk-8-jdk openjdk-17-jdk openjdk-17-jre gnome-tweaks linux-oem-22.04 mesa-utils smartmontools || true
...
# fonts for zsh
bash ubuntu_fonts_install.sh || true
