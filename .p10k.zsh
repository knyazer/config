# Generated by Powerlevel10k configuration wizard on 2022-07-15 at 08:30 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 29828.
# Wizard options: awesome-fontconfig, small icons, unicode, lean_8colors, 2 lines,
# dotted, no frame, white-ornaments, sparse, few icons, fluent, instant_prompt=verbose.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%5F'  # velvet foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION='E:'

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=1
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='E:'
